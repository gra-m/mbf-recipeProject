...
create table note (id bigint not null auto_increment, recipe_note longtext, primary key (id)) engine=InnoDB;
create table recipe (id bigint not null auto_increment, cook_time integer, description longtext, difficulty varchar(255), directions longtext, image longblob, prep_time integer, servings integer, source varchar(255), title varchar(255), url varchar(255), note_id bigint, primary key (id)) engine=InnoDB;
